...
ReportMapCtrl.$inject=['$scope', '$stateParams', '$location', 'Authentication', '$http' ,'toastr'];

function ReportMapCtrl($scope, $stateParams, $location, Authentication,$http,toastr) {
  $scope.authentication = Authentication;
